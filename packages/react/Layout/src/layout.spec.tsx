  ...
  describe("WHEN rendered", () => {
    ...
    describe("SHOULD render the columns correctly", () => {
      it("SHOULD render the default number of columns", () => {
        makeSut({});
        expect(screen.getByTestId("layout-element").getAttribute("style")).toContain("1fr");
      });
      ...
      it("SHOULD render 2 asymmetric columns correctly", () => {
        ...
        expect(screen.getByTestId("layout-element").getAttribute("style")).toContain("2fr 1fr");
      });

      it("SHOULD render 2 symmetric columns correctly", () => {
        makeSut({ columns: "2 - symmetric" });
        expect(screen.getByTestId("layout-element").getAttribute("style")).toContain("1fr 1fr");
      });

      it("SHOULD render 3 columns correctly", () => {
        makeSut({ columns: "3" });
        expect(screen.getByTestId("layout-element").getAttribute("style")).toContain("1fr 1fr 1fr");
      });
    });
  });
});
