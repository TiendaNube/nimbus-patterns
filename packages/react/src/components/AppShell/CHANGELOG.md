...
- Added fullscreen expansion support to `AppShellChat` via `expanded` and `defaultExpanded` props. ([#157](https://github.com/TiendaNube/nimbus-patterns/pull/157) by [@jffs](https://github.com/jffs))
