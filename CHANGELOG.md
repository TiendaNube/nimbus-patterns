...
- Added `publish-rc` script to publish Release Candidate versions of Nimbus packages. ([#116](https://github.com/TiendaNube/nimbus-patterns/pull/116) by [@joacotornello](https://github.com/joacotornello))
...
- Changed `Geist-Bold` font to `SemiBold` variant. ([#91](https://github.com/TiendaNube/nimbus-patterns/pull/91) by [@juanchigallego](https://github.com/juanchigallego))
...
- Updated `@nimbus-ds/tokens@9.x`. ([#85](https://github.com/TiendaNube/nimbus-patterns/pull/85) by [@juanchigallego](https://github.com/juanchigallego))
- Updated `@nimbus-ds/styles@9.x`. ([#85](https://github.com/TiendaNube/nimbus-patterns/pull/85) by [@juanchigallego](https://github.com/juanchigallego))
- Updated `@nimbus-ds/components@5.x`. ([#85](https://github.com/TiendaNube/nimbus-patterns/pull/85) by [@juanchigallego](https://github.com/juanchigallego))
- Replaced `Centranube` font with `Geist`. ([#85](https://github.com/TiendaNube/nimbus-patterns/pull/85) by [@juanchigallego](https://github.com/juanchigallego))
...
- Added stories documentation for templates. ([#60](https://github.com/TiendaNube/nimbus-patterns/pull/#60) by [@juanchigallego](https://github.com/juanchigallego))

## 2023-06-06

#### 🎉 New features

- Added new github action to comment quality checklist on every pull request. ([#59](https://github.com/TiendaNube/nimbus-patterns/pull/#59) by [@juniorconquista](https://github.com/juniorconquista))

## 2023-06-02

### 🎉 New features

- Updated storybook version to new major. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))

#### 📚 3rd party library updates

- Added `eslint-plugin-storybook@0.6.12`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Added `storybook@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Added `@storybook/blocks@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Added `@storybook/react-webpack5@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Added `@storybook/testing-library@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Updated `@storybook/addon-essentials@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Updated `@storybook/addon-interactions@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Updated `@storybook/addon-links@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Updated `@storybook/react@7.0.18`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Updated `storybook-dark-mode@3.0.0`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `@storybook/addon-a11y@6.0.13`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `@storybook/addon-controls@6.0.13`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `@storybook/addon-actions@6.0.13`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `@storybook/builder-webpack5@6.0.13`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))
- Removed `@storybook/manager-webpack5@6.0.13`. ([#58](https://github.com/TiendaNube/nimbus-patterns/pull/#58) by [@juniorconquista](https://github.com/juniorconquista))

## 2023-04-10

#### 🎉 New features

- Creating a build script to build documentation for components and subcomponents. ([#34](https://github.com/TiendaNube/nimbus-patterns/pull/#34) by [@juniorconquista](https://github.com/juniorconquista))
